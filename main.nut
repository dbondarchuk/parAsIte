...
/* public: */
	 ...
	 * @note This calls ParAsIte::ScanForDepot first, so there is no need to
	 *   do that explicitly.
	 */
...
function ParAsIte::BuildHQ(station_id, width, height)
{
...
/* static */ function ParAsIte::CargoValuator(cargo_id)
{
...
/* static */ function ParAsIte::ScanForDepot(roadtile)
{
...
/* static */ function ParAsIte::BuildDepot(roadtile)
{
	local depot = ParAsIte.ScanForDepot(roadtile);
...
/* static */ function ParAsIte::UseVehicleType(vehicle_type)
{
	switch (vehicle_type) {
...
/* static */ function ParAsIte::SomeVehicleTypeAvailable()
{
